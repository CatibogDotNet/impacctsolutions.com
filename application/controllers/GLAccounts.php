...
class GLAccounts extends CI_Controller {
  ...
  function index()
  {
    ...
    $data['title'] = "General Ledger Accounts";
    $data['headline'] = "Welcome to the General Ledger Accounts Management System";
    $data['include'] = 'glaccounts_index';

    $this->load->view('glaccounts_template', $data);
  }
  ...
  function listing()
  {
    ...
    $this->table->set_heading('', 'Bar Code', 'Description', 'Last Edit Date', 
        'Last Edit By');
    ...
    foreach ($inventory_query->result() as $inventory)
    {
      ...
      $table_row[] = $inventory->last_edit_date;
      $table_row[] = $inventory->last_edit_by;
